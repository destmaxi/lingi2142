TARGETS = mountkernfs.sh hostname.sh udev keyboard-setup mountdevsubfs.sh console-setup mountall.sh mountall-bootclean.sh mountnfs.sh mountnfs-bootclean.sh networking hwclock.sh checkroot.sh nfs-common rpcbind urandom kbd bootmisc.sh kmod checkroot-bootclean.sh checkfs.sh procps udev-finish
