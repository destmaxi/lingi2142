...
class Testrouting(unittest.TestCase):
    ...
    def test_tunnel(self):
        ...
        test_ping_everything_from_CARN
        test_ping_everything_from_HALL
        test_ping_everything_from_MICH
        test_ping_everything_from_PYTH
        test_ping_everything_from_SH1C
        test_ping_everything_from_STEV
        helpers.entete("Set inteface HALL-eth1 up")
        output = execute("sudo ip netns exec HALL ./etc/static_routes.conf/static_routes.sh %s")
